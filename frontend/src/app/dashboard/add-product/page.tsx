...
import { AlertTriangle, Bell, DollarSign, Package, Plus, Save, Search, Settings, Trash2 } from "lucide-react";
import { getProducts, type Product } from "@/frontend/lib/dashboard/api";
    ...
    <div className="space-y-5">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-gray-500">Registro, consulta y control de stock en una sola hoja.</p>
        </div>
        <a
            ...
            <table className="w-full text-sm">
              <thead className="bg-pink-50 text-pink-700">
                <tr>
                  ...
                  <th className="px-5 py-3 text-right font-medium">Nuevo stock</th>
                  <th className="px-5 py-3 text-right font-medium">Precio ref.</th>
              ...
              <tbody className="divide-y divide-gray-100">
                {filteredProducts.length === 0 ? (
                  <tr><td colSpan={9} className="px-5 py-10 text-center text-gray-400">No hay productos con esos filtros</td></tr>
                ) : (
